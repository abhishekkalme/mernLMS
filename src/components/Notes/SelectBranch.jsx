...
const backgroundImage =
  "https://images.unsplash.com/photo-1603570429985-ebfba9951a1e?auto=format&fit=crop&w=1950&q=80";
            ...
            {branches.map((branch, index) => (
              ...
              >
                <button
                  ...
                  className="bg-white/10 backdrop-blur-sm text-white px-8 py-3 rounded-lg text-lg font-medium hover:bg-white/20 transition-colors duration-200 border border-white/30 min-w-[180px]"
                >
                  {branch.name}
                </button>
              </motion.div>
