...
const courseData = {
    ...
    units: [
      {
        title: "Unit 1",
        description:
          "Basic concepts of thermodynamics, properties of steam, boilers, IC engines – types, working, comparison of 2-stroke and 4-stroke engines."
      },
      {
        title: "Unit 2",
        description:
          "Refrigeration and Air Conditioning – basics, units, vapor compression cycle, eco-friendly refrigerants."
      },
      {
        title: "Unit 3",
        description:
          "Engineering materials: classification, properties, selection. Heat treatment processes and their purposes."
      },
      {
        title: "Unit 4",
        description:
          "Power transmission methods – belts, ropes, chains, gear drives; coupling types; comparison and applications."
      },
      {
        title: "Unit 5",
        description:
          "Mechanical measurement – Pressure, temperature, speed, torque measurement devices and principles."
      }
    ]
  },
  "BT-106": {
  ...
  "BT-204": {
    ...
    units: [
      {
        title: "Unit 1",
        description: "Civil Engineering Materials: Stones, Bricks, Cement, Timber, Steel – their properties and uses. Introduction to concrete, RCC, Prestressed concrete, Concept of green building."
      },
      {
        title: "Unit 2",
        description: "Surveying: Principles, Linear and angular measurements, Chain survey, Compass survey, Leveling, Plane table surveying, Contouring, Use of modern tools – EDM, total station, GPS."
      },
      {
        title: "Unit 3",
        description: "Engineering Mechanics: Force system, Resultant and equilibrium of forces, Free body diagram, Lami’s theorem, Friction, Laws of friction, Angle of friction, Wedge friction."
      },
      {
        title: "Unit 4",
        description: "Centroid and Moment of Inertia: Centre of gravity of regular bodies, Theorem of Pappus, Moment of inertia, Parallel and perpendicular axis theorem, Polar moment of inertia."
      },
      {
        title: "Unit 5",
        description: "Kinematics and Kinetics of Particles: Rectilinear and curvilinear motion, D’Alembert’s principle, Work-energy principle, Impulse-momentum principle, Newton’s laws of motion, Circular motion."
      }
    ]
  },
  "BT-205": {
    ...
    units: [
      {
        title: "Unit 1",
        description: "Basics of Communication: Importance, Process, Levels, Types – verbal, nonverbal, visual, barriers, 7Cs, Effective communication in engineering."
      },
      {
        title: "Unit 2",
        description: "Language Fundamentals: Subject-verb agreement, Tenses, Modifiers, Voices, Prepositions, Articles, Sentence types and structures, Common errors."
      },
      {
        title: "Unit 3",
        description: "Reading Comprehension: Techniques, Skimming and scanning, Summarizing, Note-making, Interpretation of charts, graphs, advertisements, etc."
      },
      {
        title: "Unit 4",
        description: "Business Communication: Letters (inquiry, order, complaint, adjustment), Resume writing, Memo, Email etiquette, Reports (accident, progress, feasibility)."
      },
      {
        title: "Unit 5",
        description: "Presentation and Soft Skills: Seminar skills, Group discussion, Interview techniques, Time and stress management, Leadership and team building, Ethics and values."
      }
    ]
  },
  "ES-301": {
    ...
    >
      ...
      <div className="container mx-auto px-4 py-8">
        <nav className="breadcrumb flex mb-8" aria-label="Breadcrumb">
          <ol className="breadcrumb inline-flex items-center space-x-2 md:space-x-2">
            <li className="inline-flex items-center">
              <Link
                to="/"
                className="ml-1 text-gray-600 hover:text-primary md:ml-2 hover:text-[#6366F1] cursor-pointer"
              >
                Home
              </Link>
            </li>
            ...
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  ` ${
                    isActive ? "text-[#3033f3]" : "text-gray-700"
                  } hover:text-[#7276fd] cursor-pointer ml-1 text-primary font-medium md:ml-2`
                }
              >
                {subject.name}
              </NavLink>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 py-10  ">
          {subject.units.map((unit, index) => (
            <div
              key={index}
              className="bg-white rounded-lg shadow-md p-6  hover:shadow-xl overflow-hidden subject-card dark:bg-gray-900 dark:hover:shadow-blue-800 dark:hover:scale-105 dark:transition-all  dark:text-gray-200 dark:border border border-[#6366f1] dark:shadow- "
            >
              ...
              <motion.div
                  ...
                  >
              <a
                href={`${API_BASE_URL}/api/download/FirstYear/${subjectCode}/${
                  index + 1
                }`}
                
                className="text-primary hover:text-primary/90 text-sm font-medium border px-4 py-2 rounded-full hover:bg-[#6366f1] bg-[#7476de]"
              ><i class="ri-download-line m-1 "></i>
                Download Notes
              </a>
              </motion.div>
            </div>
