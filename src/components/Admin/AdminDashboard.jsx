...
function AdminDashboard() {
  ...
  // Check role before showing anything
    ...
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <Link
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300 text-sm">Add Notes </p>
        </Link>
        {/* Add Syllabus */}
        <Link
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300 text-sm">View or upgrade user roles</p>
        </Link>
      </div>
    </div>
  );
